...
public class PatternFinder {
     ...
     */
    public PatternFinder(byte[] image, int width, int height) {
        this(image, null);
        this.width = width;
        this.height = height;
    }

    public PatternFinder(byte[] image, ResultPointCallback resultPointCallback) {
        this.image = image;
    ...
    private boolean crossCheckDiagonal(int startI, int centerJ, int maxCount, int originalStateCountTotal) {
        ...
        int i = 0;
        while (startI >= i && centerJ >= i && (image[(centerJ - i) + (startI - i) * width] == 0)) {
            stateCount[2]++;
            i++;
        }
        ...
        i = 1;
        while (startI + i < maxI && centerJ + i < maxJ && (image[(centerJ + i) + (startI + i) * width] == 0)) {
            stateCount[2]++;
            i++;
        }
    ...
    private float crossCheckVertical(int startI, int centerJ, int maxCount,
        ...
        int i = startI;
        while (i >= 0 && (image[(centerJ) + (i) * width] == 0)) {
            stateCount[2]++;
            i--;
        }
        if (i < 0) {
        ...
        while (i >= 0 && !(image[(centerJ) + (i) * width] == 0) && stateCount[1] <= maxCount) {
            stateCount[1]++;
            i--;
        }
        // If already too many modules in this state or ran off the edge:
        ...
        while (i >= 0 && (image[(centerJ) + (i) * width] == 0) && stateCount[0] <= maxCount) {
            stateCount[0]++;
            i--;
        }
        if (stateCount[0] > maxCount) {
        ...
        i = startI + 1;
        while (i < maxI && (image[(centerJ) + (i) * width] == 0)) {
            stateCount[2]++;
            i++;
        }
        if (i == maxI) {
        ...
        while (i < maxI && !(image[(centerJ) + (i) * width] == 0) && stateCount[3] < maxCount) {
            stateCount[3]++;
            i++;
        }
        ...
        while (i < maxI && (image[(centerJ) + (i) * width] == 0) && stateCount[4] < maxCount) {
            stateCount[4]++;
            i++;
        }
        if (stateCount[4] >= maxCount) {
    ...
    private float crossCheckHorizontal(int startJ, int centerI, int maxCount,
        ...
        int j = startJ;
        while (j >= 0 && (image[(j) + (centerI) * width] == 0)) {
            stateCount[2]++;
            j--;
        }
        if (j < 0) {
        ...
        while (j >= 0 && !(image[(j) + (centerI) * width] == 0) && stateCount[1] <= maxCount) {
            stateCount[1]++;
            j--;
        }
        ...
        while (j >= 0 && (image[(j) + (centerI) * width] == 0) && stateCount[0] <= maxCount) {
            stateCount[0]++;
            j--;
        }
        if (stateCount[0] > maxCount) {
        ...
        j = startJ + 1;
        while (j < maxJ && (image[(j) + (centerI) * width] == 0)) {
            stateCount[2]++;
            j++;
        }
        if (j == maxJ) {
        ...
        while (j < maxJ && !(image[(j) + (centerI) * width] == 0) && stateCount[3] < maxCount) {
            stateCount[3]++;
            j++;
        }
        ...
        while (j < maxJ && (image[(j) + (centerI) * width] == 0) && stateCount[4] < maxCount) {
            stateCount[4]++;
            j++;
        }
        if (stateCount[4] >= maxCount) {
